...
function VolumeStockChart() {
  ...
  useEffect(() => {
    ...
    const getPrice = axios.get<Response>(`http://localhost:8080/api/daily/price/companies/${code}`, config);
    const getVolume = axios.get<Response>(`http://localhost:8080/api/daily/volume/companies/${code}`, config);
